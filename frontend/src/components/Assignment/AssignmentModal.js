...
const AssignmentModal = ({ isEdit, initialData, onClose, onSubmit }) => {
    const [formData, setFormData] = useState({
        ...
        handwrittenRequired: initialData?.handwrittenRequired || false
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formDataObj.append('handwrittenRequired', formData.handwrittenRequired ? 'true' : 'false');
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group checkbox-group">
                        ...
                        <p className="helper-text">
                            When enabled, students must upload a scanned handwritten PDF. Typed submissions will be rejected automatically.
                        </p>
                    </div>
